...
namespace Mkey
{
    ...
    public class LineBehaviorEditor : Editor
    {
        ...
        private ReorderableList dotList;

        private void OnEnable()
        {
            dotList = new ReorderableList(serializedObject, serializedObject.FindProperty("keyDots"));
        }
        ...
        public override void OnInspectorGUI()
        {
          ...
          //  ShowPropertiesBox("", new string[] { "button" }, false);
            #endregion
         //   dotList.DoLayoutList();

            #region dots
            EditorGUILayout.BeginVertical("box");
            EditorGUI.indentLevel += 1;
            EditorGUILayout.Space();
            ShowProperties("Line dots: ", new string[] { "keyDots", "dotMaterial", "dotSprite", "dotDistance", "burnTime", "dotList", "dotSortingOrder" }, true);
